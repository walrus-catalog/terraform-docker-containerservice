...
| <a name="input_infrastructure"></a> [infrastructure](#input\_infrastructure) | Specify the infrastructure information for deploying.<br><br>Examples:<pre>infrastructure:<br>  pause_image: string, optional        # allow for worker containers crashing or restarting without losing the network.<br>  network_id: string<br>  domain_suffix: string, optional</pre> | <pre>object({<br>    pause_image   = optional(string, "docker/desktop-kubernetes-pause:3.9")<br>    network_id    = string<br>    domain_suffix = optional(string, "cluster.local")<br>  })</pre> | n/a | yes |
